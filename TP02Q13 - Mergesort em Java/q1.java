...
public class q1 {
	static Musica[] array = new Musica[100];
	...
	public static void merge(Musica[] a, Musica[] l, Musica[] r, int left, int right) {
	...
	public static void mergeSortEngine(Musica[] a, int m) {
		if (m < 2) {
			return;
		}
		int mid = m / 2;
		Musica[] l = new Musica[mid];
		Musica[] r = new Musica[m - mid];
